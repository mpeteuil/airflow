...
class SchedulerJobTest(unittest.TestCase):
    ...
    def test_dag_catchup_option(self):
        ...
        # now: 2017-09-21 00:00:00
        # start_date: 2017-09-18 23:00:00
        two_days_one_hour_ago = (now - datetime.timedelta(days=2,hours=1)).replace(minute=0, second=0, microsecond=0)
        one_day_and_three_minutes_ago = (now - datetime.timedelta(days=1)).replace(minute=0,second=0,microsecond=0) - datetime.timedelta(minutes=3)

        START_DATE = six_hours_ago_to_the_hour
        START_DATE2 = two_days_one_hour_ago
        ...
        # The DR should be scheduled in the last day, not 2 days ago
        self.assertGreater(dr.execution_date, one_day_and_three_minutes_ago)
